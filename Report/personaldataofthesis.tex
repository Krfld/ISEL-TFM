...
%% ---------------------------------------------------%%
\adviser[m]{Carlos Jorge de Sousa Gonçalves}{PhD}
...
%% ---------------------------------------------------%%
\jury[p]{PhD António Gelásio Frazão Isidro Teófilo}
%% Referees
\jury[a]{PhD José Manuel de Campos Lages Garcia Simão}
\jury[a]{PhD Carlos Jorge de Sousa Gonçalves}
