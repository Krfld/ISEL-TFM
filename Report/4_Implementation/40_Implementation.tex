...
we'll then store on the contract as the base URI.

The files would be stored like the Figure~\ref{fig:metadata_storage} shows,
being the packages 1 and 3 with shared metadata, and the package 2 with
individual NFTs.
